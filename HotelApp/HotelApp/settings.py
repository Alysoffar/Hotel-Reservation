...
TEMPLATE_DIR = os.path.join(BASE_DIR,"HotelApp","templates")

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/5.0/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-o^6pw#m=9z_raj*cn4xmfu^_+un8o#6mk8fopg=9!6jd)rmi&r'
...
INSTALLED_APPS = [
    ...
    'RoomsBooking.apps.RoomsbookingConfig',
    'crispy_forms',
    'crispy_bootstrap5',
    'rest_framework',
